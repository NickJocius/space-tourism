...
const Titan = () => {
    return (
        <div className={`w-full`}>
            <h1 className={`text-white font-barlow text-8xl py-6`}>TITAN</h1>
            ...
            <div className={`grid grid-cols-2 text-white`}>
                <div className={`flex flex-col `}>
                    ...
                    <p className={`uppercase text-lg font-belle font-bold`}>1.6 Bil. KM</p>
                </div>
                <div className={`flex flex-col `}>
                    <h3 className={`uppercase text-xs font-barlow`}>Est. Travel Time</h3>
                    <p className={`uppercase text-lg font-belle font-bold`}>7 years</p>
                </div>
            </div>
        </div>
    )
